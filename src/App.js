        ...
        <div id="pad-panel">
          <div className="drum-pad" id="q-pad">
            <audio
              ...
              id="Q"
            />
            <button className={estiloQ} onClick={activityQ}>
              Q
            </button>
          </div>
          ...
          <div className="drum-pad" id="w-pad">
            <audio
              ...
              id="W"
            />
            <button className={estiloW} onClick={activityW}>
              W
            </button>
          </div>
          ...
          <div className="drum-pad" id="e-pad">
            <audio
              ...
              id="E"
            />
            <button className={estiloE} onClick={activityE}>
              E
            </button>
          </div>
          ...
          <div className="drum-pad" id="a-pad">
            <audio
              ...
              id="A"
            />
            <button className={estiloA} onClick={activityA}>
              A
            </button>
          </div>
          ...
          <div className="drum-pad" id="s-pad">
            <audio
              ...
              id="S"
            />
            <button className={estiloS} onClick={activityS}>
              S
            </button>
          </div>
          ...
          <div className="drum-pad" id="d-pad">
            <audio
              ...
              id="D"
            />
            <button className={estiloD} onClick={activityD}>
              D
            </button>
          </div>
          ...
          <div tabIndex="0" className="drum-pad" id="z-pad">
            <audio
              ...
              id="Z"
            />
            <button className={estiloZ} onClick={activityZ}>
              Z
            </button>
          </div>
          ...
          <div className="drum-pad" id="x-pad">
            <audio
              ...
              id="X"
            />
            <button className={estiloX} onClick={activityX}>
              X
            </button>
          </div>
          ...
          <div className="drum-pad" id="c-pad">
            <audio
              ...
              id="C"
            />
            <button className={estiloC} onClick={activityC}>
              C
            </button>
          </div>
        </div>
